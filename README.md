...
|--------|-----------------|------------------------|----------------------|-----------------|
| 1      | Task management | <ul> <li>- create a Task object with name, date and deadline<br><li>- aggregate multiple tasks into one general list</ul> </br> | [Task](src/main/java/hwr/oop/toodleedoo/Task.java), [TaskList](src/main/java/hwr/oop/toodleedoo/TaskList.java), [TaskManager](src/main/java/hwr/oop/toodleedoo/TaskManager.java), [GeneralTaskList](src/main/java/hwr/oop/toodleedoo/GeneralTaskList.java) | [TaskTest.java](src/test/java/hwr/oop/toodleedoo/TaskTest.java), [GeneralTaskListTest.java](src/test/java/hwr/oop/toodleedoo/GeneralTaskListTest.java) |
| 2 | Kanban | <ul> <li>- save multiple tasks into a kanban category<br><li>- load saved tasks from files into their kanban categories<br><li>- add tasks to and delete tasks from kanban category<br><li>- move a task between kanban categories<br><li>- print out kanban board </ul> </br>| [KanbanBoard](src/main/java/hwr/oop/toodleedoo/KanbanBoard.java), [KanbanCategory](src/main/java/hwr/oop/toodleedoo/KanbanCategory.java), [TaskList](src/main/java/hwr/oop/toodleedoo/TaskList.java) | [KanbanCategoryTest.java](src/test/java/hwr/oop/toodleedoo/KanbanCategoryTest.java), [KanbanBoardTest.java](src/test/java/hwr/oop/toodleedoo/KanbanBoardTest.java) | 
| 3 | Display | <ul> <li>- display all tasks<br><li>- display tasks filtered (and ordered) by date or deadline </ul> </br> | [Display](src/main/java/hwr/oop/toodleedoo/Display.java) | [DisplayTest.java](src/test/java/hwr/oop/toodleedoo/DisplayTest.java) |
| 4 | Reusability | <ul> <li>- save GeneralTaskList and each KanbanCategory to a file<br><li> - load data from these files back into usable objects </ul> </br>| [FileLoading](src/main/java/hwr/oop/toodleedoo/FileLoading.java), [FileSaving](src/main/java/hwr/oop/toodleedoo/FileSaving.java), [LocalDateTransformer](src/main/java/hwr/oop/toodleedoo/LocalDateTransformer.java) | [FileLoadingTest.java](src/test/java/hwr/oop/toodleedoo/FileLoadingTest.java), [FileSavingTest.java](src/test/java/hwr/oop/toodleedoo/FileSavingTest.java), [LocalDateTransformer.java](src/test/java/hwr/oop/toodleedoo/LocalDateTransformerTest.java) |
